...
- (void) viewDidLoad
{
    ...
    float navigationHeight = 64.0f;
    tableView.frame = CGRectMake(self.view.bounds.origin.x,
                                   self.view.bounds.origin.y+navigationHeight,
                                   self.view.bounds.size.width,
                                   self.view.bounds.size.height-navigationHeight);
